...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_tkl_ansi_wkl(
    RESET,          RGB_TOG, RGB_RMOD, RGB_MOD, RGB_M_P,      RGB_HUD, RGB_HUI, RGB_SAD, RGB_SAI,     RGB_VAD, RGB_VAI, RGB_M_B, RGB_M_P,                BL_TOGG, BL_DEC,  BL_INC,
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                                                   _______, 
    _______, KC_LGUI,                   _______,                                     KC_APP,           _______,                                          _______, _______, _______ ),
